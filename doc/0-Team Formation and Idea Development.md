...
| 🔐 **Account Creation & Login** | - User account creation required. <br> - Login needed to create an event. <br> - Creator account creation available. <br> - Verified creators (SIREN/SIRET/Associations). |
